...
form === null || form === void 0 ? void 0 : form.addEventListener("submit", (e) => {
    ...
    fetch(url)
        ...
        li.classList.add("city", "border-2", "border-gray-500", "hover:border-gray-700", "text-gray-700", " hover:text-gray-900", "py-4", "m-2", "rounded-xl", "cities-container", "hover:bg-gray-100", "w-2/3", "md:w-auto", "mx-auto", "md:mx-2");
        const markup = `
        <div class="relative">
